...
function OpenBajuMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		align    = 'top-left',
		elements = {
			{label = 'Baju Pasien',     value = 'baju_pasien'},
	...
	while true do
		...
		for i=1, #Config.Zones, 1 do
			...
			if #(coords - Zones) < 1.0 then
            	...
            	AddTextComponentString('~h~Tekan ~o~ E ~w~ untuk mengambil ~y~baju~s~.')
		...
		if not isInHospitallistingMarker and hasAlreadyEnteredMarker then --boolean ? return
